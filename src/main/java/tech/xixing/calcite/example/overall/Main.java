package tech.xixing.calcite.example.overall;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    String userPath = "/Users/liuzhifei/workspace/designpatterns/src/main/resources/user.csv";
    String orderPath = "/Users/liuzhifei/workspace/designpatterns/src/main/resources/order.csv";
    ...
    RuleSet rules = RuleSets.ofList(
            ...
            CoreRules.FILTER_INTO_JOIN,  //谓词下推
